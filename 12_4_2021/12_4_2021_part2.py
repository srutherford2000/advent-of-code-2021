...
for board in board_list:
    ...
    board_winners[earliest_winner] = board


latest_winner= max(board_winners.keys())
winning_board = board_winners[latest_winner]

sum_of_unmarked = 0
numbers_called = bingo_nums[:latest_winner+1]
...
last_number = bingo_nums[latest_winner]
